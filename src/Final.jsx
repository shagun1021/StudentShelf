    ...
    <>
      ...
      <div>
        <div className="mt-20 justify-between  flex">
          <div className="flex flex-col justify-center text-center gap-5 h-[450px] pt-14   w-1/2">
            <h1 className="text-6xl">
              Hello..!
              <span className="shake-hand">👋🏻</span>
            </h1>
            <h2 className="text-4xl ml-24">
              I Am <span className="text-pink-600">S</span>hagun
            </h2>

            <div className="flex justify-center gap-10 pl-20 pt-6">
          ...
          <img src={img} className="w-72 mr-80 rounded-3xl" alt="Profile" />
        </div>

        <div className="h-96 mt-28 flex justify-center pt-28 mb-16 ">
          <div className="card">
            <p className=" blockHover">
              <span className="hoverHidden transition ease-in-out delay-200">
                Personal Info
              </span>
              <div className="hidden text-2xl   w-full  text-center blk transition ease-in-out delay-200 text-white">
              <div className="w-full  flex justify-center">
                <h1 className="bg-pink-700 w-max px-2"> Personal Info</h1>
                </div>
                <div className=" shadow-sm py-4 shadow-pink-700  mx-14">
                <h1>Name:Shagun</h1>
            ...
            <p className=" blockHover">
              ...
              <div className="hidden text-2xl   w-full  text-center blk transition ease-in-out delay-200 text-white">
              <div className="w-full  flex justify-center">
                <h1 className="bg-pink-700 w-max px-2"> Educational Info</h1>
                </div>
                <div className=" shadow-sm py-4 shadow-pink-700  mx-14">
                <h1>Name:Shagun</h1>
